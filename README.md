...
<p align="center">
  <img src="output/risk_dense.jpg" width="90%">
</p>
...
<p align="center">
  <img src="output/risk_moderate.jpg" width="90%">
</p>
...
SentinelX/
│
├── people_detection/                   Module 1 : Person Detection
│   ├── files/                          Fine-tuning + dataset prep
│   │   ├── crowdhuman.yaml
│   │   ├── finetune_person.py
│   │   ├── prepare_crowdhuman.py
│   │   └── requirements_finetune.txt
│   ├── output/                         Runtime output (JSON frame logs)
│   │   ├── latest_frame.json
│   │   ├── session_log.jsonl
│   │   ├── v1_latest_frame.json
│   │   └── v1_session_log.jsonl
│   ├── testing/                        Benchmarks + test images/videos
│   ├── best.pt                         Fine-tuned weights (6.0 MB)
│   ├── best.py                         Live detection/tracking pipeline
│   ├── crowd_detector.py
│   ├── requirements.txt
│   └── .gitignore
│
├── crowd_analysis/                     Module 2 : Crowd Analytics
│   ├── analytics/
│   │   ├── __init__.py
│   │   ├── analytics_engine.py
│   │   ├── config.py
...
│   │   ├── heatmap.py
│   │   ├── models.py
│   │   ├── tracker.py                 Custom NumPy centroid tracker
│   │   └── trajectory.py
│   └── test/                          Full pytest suite (mirrors analytics/)
│
├── risk_engine/                       Module 3 : Risk Prediction Engine
│   ├── routers/
│   │   ├── __init__.py
│   │   ├── alerts.py                  GET /alerts/latest
│   │   ├── history.py                 GET /history
│   │   ├── risk.py                    POST /risk/check, GET /risk/sample
│   │   └── stats.py                   GET /stats/summary
│   ├── alert_engine.py                Alert text generation
│   ├── app.py                         FastAPI app entrypoint
│   ├── database.py                    In-memory history store
│   ├── models.py                      Pydantic schemas
│   ├── risk_engine.py                 Scoring logic
│   ├── sample_data.json               Sample payload for /risk/sample
│   ├── requirements.txt
│   └── .gitignore
│
├── dashboard/                         Module 4 : Dashboard & Visualization
│   ├── src/
│   │   ├── components/                RiskGauge, LiveFeed, AlertsFeed,
│   │   │                              DensityHeatmap, Timeline, WhatIfPanel,
│   │   │                              CameraConfig, SideRail, TopBar, etc.
